												...
												<td>
													...
													<table class="data table table-condensed table-striped table-responsive table-hover">
														...
														<tr>
															...
															<td>
																{html_options style="height:205px;" class="form-control" data-placeholder="Choose categories to exclude" multiple=multiple name="exccat[]" options=$catlist selected=$userexccat}
															</td>
														</tr>
														</tbody>
													</table>
